function [DCM] = WSCT_model_inversion(mdp, OPTIONS, Exp_MDP, field_params, FIT_PARAMS)
% MODEL INVERSION
%==============================================================
DCM.mdp = mdp;
DCM.OPTIONS = OPTIONS;
...
disp('Starting...')
DCM = WSCT_Estimate_parameters(DCM, FIT_PARAMS); % Run the parameter estimation function
disp('Finished!')
